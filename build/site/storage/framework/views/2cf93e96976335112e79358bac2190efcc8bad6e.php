<div id="programming">
    <div>
        <label style="width: 100%; text-align: center; font-size: 40px;">Programação</label>
    </div>
    <h1 style="text-align: center; font-size: 30px;">04/05/2018 – Sexta-feira</h1>
    <table class="table">
        <thead>
        <tr>
            <th class="col-md-4" scope="col">Programação</th>
            <th class="col-md-4" scope="col">Horário</th>
            <th class="col-md-4" scope="col">Local</th>
        </tr>
        </thead>
        <tbody>
        <tr>
            <td>Recepção  dos participantes</td>
            <td>**</td>
    ...
    <h1 style="text-align: center; font-size: 30px;">05/05/2018 – Sábado</h1>
    <table class="table">
        <thead>
        <tr>
            <th class="col-md-4" scope="col">Programação</th>
    ...
    <h1 style="text-align: center; font-size: 30px;">06/05/2018 – Domingo</h1>
    <table class="table">
        <thead>
        <tr>
            <th class="col-md-4" scope="col">Programação</th>
