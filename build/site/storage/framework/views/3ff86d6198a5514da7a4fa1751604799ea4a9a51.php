                ...
                <div class="panel panel-default">
                   ...
                   <div style="padding-left: 50px; padding-right: 50px;">
                       <div style="width: 100%; text-align: center; font-size: 40px;">
                           <label>Vagas restantes: <?php echo e($totalParticipants); ?></label>
                           <div class="row">
                                <button type="button" onclick="location.href='<?php echo e(route('participants.create')); ?>'">Inscreva-se</button>
                           </div>
                       </div>
                       <div id="info">
